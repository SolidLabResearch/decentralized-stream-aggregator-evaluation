...
function printAnalysisReport(summaryStats) {
    ...
    console.log(`⏱️  Average latency increases by ${latencyIncrease.toFixed(0)}ms from 1 to ${lastClient.clients} clients`);
    console.log(`⚠️  Events exceeding delay threshold increase by ${exceedsDelayIncrease.toFixed(1)}% from 1 to ${lastClient.clients} clients`);
